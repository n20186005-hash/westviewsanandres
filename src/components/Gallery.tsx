...
const photoFiles = [
  'westviewsanandres (1).jpg',
  'westviewsanandres (2).jpg',
  'westviewsanandres (3).jpg',
  'westviewsanandres (4).jpg',
  'westviewsanandres (5).jpg',
  'westviewsanandres (6).jpg',
  'westviewsanandres (7).jpg',
  'westviewsanandres (8).jpg',
  'westviewsanandres (9).jpg',
  'westviewsanandres (10).jpg',
  'westviewsanandres (11).jpg',
  'westviewsanandres (12).jpg',
  'westviewsanandres (13).jpg',
  'westviewsanandres (14).jpg',
  'westviewsanandres (15).jpg',
  'westviewsanandres (16).jpg',
  'westviewsanandres (17).jpg',
  'westviewsanandres (18).jpg',
  'westviewsanandres (19).jpg',
  'westviewsanandres (20).jpg',
];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="flex justify-center mt-8">
              <a
                href="https://maps.app.goo.gl/yUsqkGAHwLbrpgsr8"
                target="_blank"
